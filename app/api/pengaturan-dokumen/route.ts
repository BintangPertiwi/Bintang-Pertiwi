...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ success: true, message: "Pengaturan dokumen berhasil diperbarui" });
  } catch (error) {
    console.error("Failed to update pengaturan dokumen:", error);
    return NextResponse.json(
