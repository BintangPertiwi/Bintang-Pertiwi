...
const sections: DeveloperSection[] = [
  ...
  },
  {
    ...
    description: "Kelompok mahasiswa dari Universitas Mulawarman (UNMUL) dalam program Kuliah Kerja Nyata (KKN) 4 Bina Desa yang berdedikasi dalam melaksanakan program pengabdian masyarakat. Kehadiran dan antusiasme mereka turut mengiringi langkah awal digitalisasi potensi UMKM di wilayah Bintang Pertiwi.",
