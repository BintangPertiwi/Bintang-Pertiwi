...
import { getPengaduanById } from "@/lib/db/queries/pengaduan";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="max-w-3xl space-y-6 pb-20">
              ...
              <div className="flex items-start justify-between w-full pr-4 text-left">
                <div className="w-full">
                  ...
                  <CardDescription className="flex items-center mt-2 text-sm font-normal justify-between w-full">
                    ...
                    <Badge className={getStatusColor(pengaduan.status || "Menunggu")} variant="outline">
        ...
        <StatusUpdaterDetail id={pengaduan.id} currentStatus={pengaduan.status || "Menunggu"} />
      </div>
    </div>
  );
}
